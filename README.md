...
| *DevOps*         | Docker, Microservices, CI/CD, Unit Testing, Heroku, Netlify, Hostinger, DigitalOcean, AWS, Task Scheduling and Distributed Task Processing with Celery and Redis       |
